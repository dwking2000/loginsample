package site.verity.demos.login.repository;

import site.verity.demos.login.LoginsampleApp;
import site.verity.demos.login.config.Constants;
import site.verity.demos.login.config.audit.AuditEventConverter;
import site.verity.demos.login.domain.PersistentAuditEvent;
...
import static site.verity.demos.login.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
